...
module Microsoft.ApplicationInsights {
    ...
    export class Sender {
        ...
        private _xhrSender(payload: string[], isAsync: boolean) {
            ...
            xhr.onerror = (event: ErrorEvent|ProgressEvent<EventTarget>) => this._onError(payload, this._formatErrorMessageXhr(xhr), event);
        ...
        private _xdrSender(payload: string[], isAsync: boolean) {
            ...
            xdr.onerror = (event: ErrorEvent|ProgressEvent<EventTarget>) => this._onError(payload, this._formatErrorMessageXdr(xdr), event);
